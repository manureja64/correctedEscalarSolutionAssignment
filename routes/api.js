...
router.post('/business/create/:userId', business_controller.business_create_post);
...
router.post('/product/user/create/:userId', product_controller.product_user_create_post);
...
router.post('/product/business/create/:businessId', product_controller.product_business_create_post);
